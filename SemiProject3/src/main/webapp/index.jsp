    ...
    <section id="main-content1">
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                <img src="<%=request.getContextPath()%>/view/resources/img/main_01.jpg" onclick="location.href='<%=request.getContextPath()%>/view/mapSearch.jsp';" style="cursor: pointer;">
            </div>

            <div class="mySlides fade ">
                <img src="<%=request.getContextPath()%>/view/resources/img/main_02.jpg" onclick="location.href='<%=request.getContextPath()%>/view/mapSearch.jsp';">
            </div>

            <div class="mySlides fade ">
                <img src="<%=request.getContextPath()%>/view/resources/img/main_03.jpg" onclick="<%=request.getContextPath()%>/view/mapSearch.jsp';" style="cursor: pointer;">
            </div>
            <div class="mySlides fade ">
                <img src="<%=request.getContextPath()%>/view/resources/img/main_04.jpg" onclick="<%=request.getContextPath()%>/view/mapSearch.jsp';" style="cursor: pointer;">
            </div>
            <div class="mySlides fade ">
                <img src="<%=request.getContextPath()%>/view/resources/img/main_05.jpg" onclick="<%=request.getContextPath()%>/view/mapSearch.jsp';" style="cursor: pointer;">
            </div>
    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col-md-4 d-flex align-items-center">
                <span class="text-muted">&copy; 모모모 전기차. All rights reserved.</span>
            </div>
